 ...
 * FUNCTIONALITY *
 *
 * 1. The for loop is initialized with letter = 'a'
 * and the condition is letter <= 'z'.
 *
 ...
 *
 * 5. If the condition is false, the putchar function
 * is executed and the letter is printed.
 *
