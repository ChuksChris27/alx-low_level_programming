 ...
 * 2. We start a for loop that will run as long
 * as digit is less than or equal to 9.
 * 3. We print the value of digit.
 * 4. We increment digit by 1.
 * 5. If digit is equal to 9, we set it to a.
 * 6. We start a for loop that will run as long
 * as digit is less than or equal to f.
